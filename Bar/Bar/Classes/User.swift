...
struct User: Codable, Identifiable, Hashable {
    ...
    var firstName, lastName, phoneNumber, gender, genderPreference, education, profession, company, city, state, lookingFor, bio, order, hobby, quotes, guiltyPleasure, forFun, currentBarID, profURL, matcherID: String
    ...
    var showsLocation, lookingForDealbreaker, religionDealbreaker, openToAll: Bool
    var dob: Date

    enum CodingKeys: String, CodingKey {
        case firstName, lastName, phoneNumber, gender, genderPreference, education, gradYear, profession, company, city, state, lookingFor, bio, order, hobby, quotes, guiltyPleasure, forFun, profURL, matcherID, minAge, maxAge, likes, matches, contacts, imageLinks, customPrompts, customResponses, religions, religiousPreferences, seenBefore, showsLocation, lookingForDealbreaker, religionDealbreaker, openToAll, dob, currentBarID
    }
